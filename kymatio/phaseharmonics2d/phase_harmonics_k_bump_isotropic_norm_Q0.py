...
from .backend import cdgmm, Modulus, fft, \
    Pad, SubInitSpatialMeanC, SubInitMeanIso, PhaseHarmonicsIso, mulcu, \
    conjugate, DivInitStdQ0
...
class PhaseHarmonics2d(object):
    ...
    def build(self):
        ...
        self.divinitstdQ0 = DivInitStdQ0()
    ...
    def forward(self, input):
        ...
        #K = 2**dj + dk + 1
        #print(K)
        #k = torch.arange(0, K).type(torch.float)
        pad = self.pad
        ...
        #            print(xpsi_iso_bc.size())
                    ...
                    # normalize by std
                    xpsi_iso_bc = self.divinitstdQ0(xpsi_iso_bc)
        #            print(xpsi_iso_bc.size())
